...
public class FrmReporteMatrVigente extends JFrame implements ActionListener, KeyListener {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FrmReporteMatrVigente frame = new FrmReporteMatrVigente();
	 ...
	 * Create the frame.
	 */
	public FrmReporteMatrVigente() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(FrmReporteMatrVigente.class.getResource("/img/people_114360.png")));
		...
		lblConsultaDeAlumnos = new JLabel("Reporte alumnos con matricula vigente");
		...
		btnCerrar.setIcon(new ImageIcon(FrmReporteMatrVigente.class.getResource("/img/cerrar.png")));
